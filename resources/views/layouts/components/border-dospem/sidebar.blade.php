            ...
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item {{ request()->is('bimbingan*') ? 'active' : '' }}">
                    <a data-bs-toggle="collapse" href="#bimbingan"
                        class="{{ request()->is('bimbingan*') ? '' : 'collapsed' }}">
                        <i class="fas fa-bullhorn"></i>
                        <p>Bimbingan</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse {{ request()->is('bimbingan*') ? 'show' : '' }}" id="bimbingan">
                        <ul class="nav nav-collapse">
                            <li class="{{ request()->is('bimbingan/read') ? 'active' : '' }}">
                                <a href="{{ url('/bimbingan/read') }}">
