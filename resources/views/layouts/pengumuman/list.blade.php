<div class="container">
    ...
    <a href="#" class="btn btn-primary mb-3">Buat Pengumuman Baru</a>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex gap-2">
                        ...
                        <button class="btn btn-danger btn-sm" onclick="confirm('Apakah Anda yakin ingin menghapus pengumuman ini?')">Hapus</button>
                    </div>
                </td>
            </tr>
            <tr>
