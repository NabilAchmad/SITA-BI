...
@section('content')
    ...
    <div class="container">
        <ul class="nav nav-tabs nav-tabs-modern nav-tabs-hover-effect" id="judulTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="acc-tab" href="{{ route('kajur.judul.acc') }}" role="tab" aria-selected="false">
                    <i class="bi bi-check-circle-fill me-2 text-success"></i>Judul Disetujui
                </a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link" id="tolak-tab" href="{{ route('kajur.judul.tolak') }}" role="tab"
