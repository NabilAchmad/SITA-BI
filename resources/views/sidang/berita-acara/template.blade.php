<div class="container my-5 px-4">
    ...
    <p class="text-center text-muted mb-4">Silakan isi form berikut untuk membuat berita acara sidang, sempro, atau semhas.</p>
    ...
    <form action="" method="POST" class="mx-auto" style="max-width: 700px;">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="judul_tugas_akhir" name="judul_tugas_akhir" rows="3" placeholder="Masukkan judul tugas akhir" required></textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="dosen_penguji" name="dosen_penguji" placeholder="Masukkan nama dosen penguji" required>
        </div>
