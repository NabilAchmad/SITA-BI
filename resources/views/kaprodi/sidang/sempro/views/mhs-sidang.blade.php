...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 animate__animated animate__fadeIn">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 bg-transparent">
                <li class="breadcrumb-item"><a href="{{ route('sidangDashboard.page') }}" class="text-decoration-none hover-effect">Dashboard</a></li>
    ...
    <ul class="nav nav-pills mb-4 custom-nav-pills">
        <li class="nav-item">
            <a class="nav-link {{ request('prodi') == null ? 'active pulse' : '' }}"
                href="{{ route('kaprodisidang.menunggu.penjadwalan.sempro') }}">
                <i class="bi bi-grid-3x3-gap me-1"></i> Semua
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ request('prodi') === 'D4' ? 'active pulse' : '' }}"
                href="{{ route('kaprodisidang.menunggu.penjadwalan.sempro', ['prodi' => 'D4']) }}">
                <i class="bi bi-mortarboard me-1"></i> D4
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ request('prodi') === 'D3' ? 'active pulse' : '' }}"
                href="{{ route('kaprodisidang.menunggu.penjadwalan.sempro', ['prodi' => 'D3']) }}">
    ...
    <!-- Modern Search Form -->
    <form method="GET" action="{{ route('kaprodisidang.menunggu.penjadwalan.sempro') }}" class="mb-4">
                                ...
                                <tr class="hover-row">
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-primary btn-sm btn-jadwalkan hover-effect"
                                            ...
                                            data-url="{{ route('kaprodijadwal-sempro.store') }}"
...
@include('kaprodi.sidang.sempro.modal.penguji')
@include('kaprodi.sidang.sempro.modal.jadwal-sidang')
