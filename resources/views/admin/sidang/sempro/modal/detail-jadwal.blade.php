        ...
        <div id="cardFlip" class="card-flip"
                ...
                <div class="card shadow-sm rounded-4 border-light mb-5"
                    ...
                    <div class="card-body p-lg-5 p-4">
                        ...
                        <div class="border-top mt-4 pt-3 d-flex flex-wrap justify-content-end align-items-center gap-2">
                            ...
                            <form action="{{ route('jadwal-sempro.destroy', $jadwal->id) }}" method="POST"
            ...
            <div class="card-back">
                <div class="card shadow-sm rounded-4 border-light mb-5">
                    ...
                    <div class="card-body p-lg-5 p-4">
                        <form id="editJadwalForm" method="POST" action="{{ route('jadwal-sempro.update', $jadwal->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                <div class="col-md-6">
...
@push('scripts')
    <script>
        ...
        function submitStatus(sidangId, status) {
            ...
            form.action = `/admin/sidang/sempro/tandai-sidang/${sidangId}`;
