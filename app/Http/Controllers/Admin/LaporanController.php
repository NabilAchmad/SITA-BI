...
class LaporanController extends Controller
{
    public function show()
    {
        ...
        $mahasiswaPerStatus = Mahasiswa::select('status', DB::raw('COUNT(*) as total'))
            ->groupBy('status')->get();
        ...
        // Similarity Check (kelompok skor)
        ...
        // Peran Dosen sebagai Penguji (opsional)
