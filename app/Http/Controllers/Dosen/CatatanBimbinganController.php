...
class CatatanBimbinganController extends Controller
{
     ...
     * Metode ini dipanggil dari form di halaman detail bimbingan.
     */
    public function store(Request $request, TugasAkhir $tugasAkhir)
    {
        ...
        try {
            // 2. Panggil service untuk melakukan logika penyimpanan
            ...
            // 4. Jika service melempar error, tangkap dan tampilkan pesannya
            return redirect()->back()->with('alert', [
                'type' => 'error',
                'title' => 'Gagal!',
