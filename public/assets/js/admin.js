...
$(document).ready(function () {
	if (localStorage.getItem('sidebar_minimize') === null) {
		localStorage.setItem('sidebar_minimize', '1');
	} else {
...
$(document).ready(function () {
	...
	if (!minimize_sidebar) {
		...
		// --- [1] Saat load page, baca dari localStorage ---
		if (localStorage.getItem('sidebar_minimize') === '1') {
			$('.wrapper').addClass('sidebar_minimize');
			mini_sidebar = 1;
		}

		// --- [2] Set tombol sesuai kondisi wrapper sekarang ---
		...
		// --- [3] Event klik untuk toggle sidebar ---
		minibutton.on('click', function () {
			if (mini_sidebar == 1) {
				...
				minibutton.html('<i class="gg-menu-right"></i>');
				mini_sidebar = 0;
				localStorage.setItem('sidebar_minimize', '0');
			} else {
				$('.wrapper').addClass('sidebar_minimize');
				minibutton.addClass('toggled');
				minibutton.html('<i class="gg-more-vertical-alt"></i>');
